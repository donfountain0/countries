...
-- WHERE indep_year IS NOT NULL AND countries.capital > 200;
...
-- than 500, 000? The query should return the Country Name, City Name, District and Population. (2)

-- SELECT cities.name, countries.name, cities.district, cities.population FROM cities
-- JOIN countries on countries.id = cities.country_id
